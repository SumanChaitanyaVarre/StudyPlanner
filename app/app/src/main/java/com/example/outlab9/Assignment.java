...
public class Assignment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        r1 = (RecyclerView) view.findViewById(R.id.myRecycler2);
        e1 = (EditText) view.findViewById(R.id.edit_assignment1);
        e2 = (EditText) view.findViewById(R.id.edit_assignment2);
        myData = new MyCoreDatabase2(getActivity());
        dateButton = (Button) view.findViewById(R.id.datebutton2);
        timeButton = (Button) view.findViewById(R.id.timebutton2);
        saveButton = (Button) view.findViewById(R.id.save2);
        loadButton = (Button) view.findViewById(R.id.load2);
