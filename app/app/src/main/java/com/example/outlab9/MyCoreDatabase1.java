...
public class MyCoreDatabase1 extends SQLiteOpenHelper {

    static final private String DB_NAME="Education1";
    static final private String DB_TABLE = "studyplan";
    static final private int DB_VER = 1;

    Context ctx;
    SQLiteDatabase myDb;

    public MyCoreDatabase1(@Nullable Context ct) {
