 ...
 * Use the {@link Lecture#newInstance} factory method to
...
public class Lecture extends Fragment {
     ...
     * @return A new instance of fragment Lecture.
     */
    // TODO: Rename and change types and number of parameters
    public static Lecture newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        r1 = (RecyclerView) view.findViewById(R.id.myRecycler4);
        e1 = (EditText) view.findViewById(R.id.edit_lecture1);
        e2 = (EditText) view.findViewById(R.id.edit_lecture2);
        myData = new MyCoreDatabase4(getActivity());
        dateButton = (Button) view.findViewById(R.id.datebutton4);
        timeButton = (Button) view.findViewById(R.id.timebutton4);
        saveButton = (Button) view.findViewById(R.id.save4);
        loadButton = (Button) view.findViewById(R.id.load4);
